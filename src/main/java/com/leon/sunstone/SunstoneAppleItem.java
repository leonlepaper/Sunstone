...
public class SunstoneAppleItem extends Item {
	 ...
	 *
	 * Около 1.7 минуты реального времени. Значение подбиралось, когда яблоко
	 * стоило 8 блоков, то есть 72 камня; в 1.2.0 цена упала до 8 камней,
	 * а откат остался прежним.
	 */
	 ...
	 * ценой в 8 камней — просто получит подсказку и оставит его на утро.
	 */
	@Override
